...
CREATE TABLE game_action (id SERIAL, game_id INTEGER, team_at_bat INTEGER, team1_score INTEGER DEFAULT 0, team2_score INTEGER DEFAULT 0, balls INTEGER DEFAULT 0, strikes INTEGER DEFAULT 0, outs INTEGER DEFAULT 0, type game_action_type, message VARCHAR(255), date_created TIMESTAMP DEFAULT NOW());
